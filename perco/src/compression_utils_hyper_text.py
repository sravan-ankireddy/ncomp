...
from pipeline_sd_perco_hyper_text import StableDiffusionPipelinePerco
...
tokenizer = CLIPTokenizer.from_pretrained("/raid/sa53869/perco_hyper_text/checkpoint-2200", subfolder="tokenizer", revision=None)
text_encoder = CLIPTextModel.from_pretrained("/raid/sa53869/perco_hyper_text/checkpoint-2200", subfolder="text_encoder", revision=None, variant=None)
...
def compress(args):
    ...
    tokenized_captions = tokenize_captions(generated_text).to(device)
    ...
    hyper_latent = pipe.hyper_enc(latents, encoder_hidden_states)
