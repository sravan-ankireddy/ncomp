...
def main(opts):
    ...
    clip_model_name = "/home/sa53869/ncomp/veclip/checkpoints/vecapdfn_clip_h14_336/"
...
def ddp_or_single_process(argvs):
    ...
    save_path = f'./checkpoint_veclip/exp_lambda_{opts.lmbda}_seed_{opts.seed}_batch_size_{opts.batch_size}_joint_image_text_loss_coefficient_{opts.joint_image_text_loss_coefficient}_lpips_coefficient_{opts.lpips_coefficient}'
