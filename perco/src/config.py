...
class ConfigPerco:
    ...
    data_dir = "/scratch/09004/sravana/OpenImagesV6_split/"
    image_list_file = "/work/09004/sravana/ls6/ncomp/perco/src/data/list_train_files.txt"

    # global path (adjust to your needs)
    global_path = "/work/09004/sravana/ls6/ncomp/perco/src"
